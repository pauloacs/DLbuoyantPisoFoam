...
foamToVTK -useTimeName -noZero -ascii -noPointValues -fields '(delta_U delta_p_rgh U_non_cons p_rgh Cx Cy Cz delta_U_prev delta_p_rgh_prev delta_rho rho)' -excludePatches '(inlet outlet defaultFaces)' > log.foamtoVTK
